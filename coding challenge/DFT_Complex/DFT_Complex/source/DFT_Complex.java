...
public class DFT_Complex extends PApplet {
...
public PVector epiCycle(float _x, float _y, float theda, complex[] fouries) {
  //translate(_x,_y);
...
class complex {
  ...
  public complex mult(float c, float d) {
    float a=re;
    float b=im;
    float re_=a*c-b*d;
    float im_=b*c+a*d;
  ...
  public complex sumation(complex s) {
...
//}
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "DFT_Complex" };
    if (passedArgs != null) {
